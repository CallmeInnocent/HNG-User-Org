...
import com.hng.dto.ErrorDetail;
import com.hng.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleSecurityException(Exception exception) {
        ...
        return ResponseEntity.status(errorDetail.getStatus())
                .body(errorDetail);
    }
    ...
    public ResponseEntity<String> handleOrganisationNotFoundException() {

        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body("Organisation not Found");
